...
const Form = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_4l66qwn', 'template_5k073v1', formRef.current, {
  ...
  <div className=" px-4 mx-auto max-w-screen-md">
      ...
      <form onSubmit={sendEmail} ref={formRef}  className="space-y-8">
          <div className='flex flex-col sm:flex-row gap-2'>
              <input name="form_name" type="text" id="form_name" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light outline-none" placeholder="Enter your name " required/>
              <input name="form_email" type="email" id="form_email" className="block p-3 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light outline-none" placeholder="Enter Your email" required/>
          </div>
