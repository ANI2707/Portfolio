const Exp_prop = (props) => {
  return (
    <>
      <div className="border-gray-400 shadow-2xl rounded-3xl border-2 bg-[#e1e1e1] dark:bg-transparent  h-[490px] max-sm:h-[450px] p-8 hover:bg-gradient-to-tl from-[#e1e1e1] to-[#fff] dark:from-[#00040F] dark:to-[#0B274C]">
